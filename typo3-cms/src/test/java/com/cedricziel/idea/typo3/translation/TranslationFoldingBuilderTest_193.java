...
public class TranslationFoldingBuilderTest_193 extends AbstractTestCase {
    @Override
    ...
    public void testXMLTranslationsCanBeFolded() {
        ...
        myFixture.testFolding(getTestDataPath() + "/folding_xml_result_193.php");
    }
    ...
    public void testXMLTranslationsCanBeFoldedInNonDefaultLanguage() {
        ...
        myFixture.testFolding(getTestDataPath() + "/folding_nondefault_xml_result_193.php");
    }
    ...
    public void testXLFTranslationsCanBeFolded() {
        ...
        myFixture.testFolding(getTestDataPath() + "/folding_xlf_result_193.php");
    }
